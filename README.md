...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-28 19:12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/471b10f2-86d3-4d2b-bee7-239a294c6c96.git
$ cd 471b10f2-86d3-4d2b-bee7-239a294c6c96
```
